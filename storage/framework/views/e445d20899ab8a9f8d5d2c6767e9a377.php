    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-12">
                <img src="<?php echo e(asset('assets/images/photo_ptik.png')); ?>" class="about-image img-fluid" alt="">
            </div>
            ...
            <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                <div class="about-thumb">
                    ...
                    <div class="section-title-wrap d-flex justify-content-end align-items-center mb-4">
                        ...
                        <img src="<?php echo e(asset('assets/images/my_photo.png')); ?>" class="avatar-image img-fluid" alt="">
                    </div>
                ...
                <div class="profile-thumb">
                    ...
                    <div class="profile-body">
                        ...
                        <p>
                            ...
                            <span><?php echo e($birthday); ?></span>
                        </p>

                        <p>
                            <span class="profile-small-title">Phone</span> 
                            <span><a href="tel:<?php echo e($call); ?>"><?php echo e($call); ?></a></span>
                        </p>

                        <p>
                            <span class="profile-small-title">Email</span> 
                            <span><a href="mailto:<?php echo e($email); ?>"><?php echo e($email); ?></a></span>
                        </p>
                        <p>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-2 col-4 ms-auto clients-item-height organization">
                <img src="<?php echo e(asset('assets/images/Logo_OSIS.svg')); ?>" class="clients-image img-fluid" alt="">
            ...
            <div class="col-lg-2 col-4 ms-auto clients-item-height organization">
                <img src="<?php echo e(asset('assets/images/Logo LPM.png')); ?>" class="clients-image img-fluid" alt="">
            ...
            <div class="col-lg-2 col-4 ms-auto clients-item-height organization">
                <br><img src="<?php echo e(asset('assets/images/Mikroptik.png')); ?>" class="clients-image img-fluid" alt="">
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 col-4 ms-auto clients-item-height organization">
                <img style="border-radius:100%;" src="<?php echo e(asset('assets/images/adhyasta.JPG')); ?>" class="clients-image img-fluid" alt="">
            ...
            <div class="col-lg-4 col-4 ms-auto clients-item-height organization">
                <img style="border-radius:100%;" src="<?php echo e(asset('assets/images/rakernas.JPG')); ?>" class="clients-image img-fluid" alt="">
                <p><br><b style="color: var(--secondary-color);">[Volunteer]</b>
            ...
            <div class="col-lg-4 col-4 ms-auto clients-item-height organization">
                <img style="border-radius:10%;" src="<?php echo e(asset('assets/images/rs-indriati-solo-baru.png')); ?>" class="clients-image img-fluid" alt="">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-12">
                <div class="section-title-wrap d-flex justify-content-center align-items-center mb-5">
                    <img src="<?php echo e(asset('assets/images/handshake-man-woman-after-signing-business-contract-closeup.jpg')); ?>" class="avatar-image img-fluid" alt="">
            ...
            <div class="col-lg-6 col-12 pe-lg-0">
                <div class="contact-info contact-info-border-start d-flex flex-column">
                    ...
                    <ul class="footer-menu">
                        <li class="footer-menu-item"><a href="<?php echo e(route('portofolio')); ?>#section_2" class="footer-menu-link">Programming</a></li>

                        <li class="footer-menu-item"><a href="<?php echo e(route('portofolio')); ?>#section_2" class="footer-menu-link">Graphic Design</a></li>

                        <li class="footer-menu-item"><a href="<?php echo e(route('portofolio')); ?>#section_2" class="footer-menu-link">Animation</a></li>

                        <li class="footer-menu-item"><a href="<?php echo e(route('portofolio')); ?>#section_2" class="footer-menu-link">Game Development</a></li>
                    </ul>
...
<?php echo $__env->make('page_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Document\Kuliah\SMT 7\Pemrograman Web Lanjut\Pertemuan 6\Portofolio\resources\views/page_pertama.blade.php ENDPATH**/ ?>